    ...
    fun friendly(throwable: Throwable, fallback: String = "Algo deu errado, tente novamente"): String {
        ...
        return when {
            ...
            lower.contains("weak_password") || lower.contains("password should contain") ->
                "Senha muito fraca. Use letras maiúsculas, minúsculas, números e símbolos (ex: Rodape@123)."
            lower.contains("password should be at least") ->
                "Senha curta demais (mínimo 8 caracteres)."
            ...
            lower.contains("account_not_linked") || lower.contains("identity_not_found") ||
                ...
                "Essa conta foi criada com email/senha. Entre usando sua senha — depois você pode vincular o Google nas configurações."
            ...
            lower.contains("no credential") ->
                "Nenhuma conta Google disponível neste dispositivo. Adicione uma conta Google nas configurações e tente de novo."
