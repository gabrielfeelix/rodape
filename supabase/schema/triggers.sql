-- Snapshot dos triggers public — regenerado do banco vivo 2026-07-12 (pós 0003/0004)
...
CREATE TRIGGER comments_notify_on_chapter AFTER INSERT ON public.comments FOR EACH ROW EXECUTE FUNCTION notify_comment_on_chapter();
...
CREATE TRIGGER user_progress_notify_finished AFTER INSERT OR UPDATE OF current_chapter ON public.user_progress FOR EACH ROW EXECUTE FUNCTION notify_member_finished();
...
CREATE TRIGGER voting_rounds_notify_open AFTER INSERT ON public.voting_rounds FOR EACH ROW EXECUTE FUNCTION notify_voting_open();
