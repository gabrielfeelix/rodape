-- Enums public — Management API, atualizado 2026-07-12
...
CREATE TYPE public.notification_type AS ENUM ('comment_on_chapter', 'next_book_decided', 'meeting_reminder', 'member_finished', 'voting_open', 'voting_closed', 'member_removed', 'promoted_to_admin', 'super_admin_transferred', 'book_finished');
